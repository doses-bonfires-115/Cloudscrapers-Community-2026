...
# 🎮 Cloudscrapers — Community Edition

**Build towering cities above the clouds in this standalone edition.**
...
Cloudscrapers is a sci-fi city-building simulation in which players design, construct, and manage vertical metropolises rising above an endless cloud layer. This Community Edition is a standalone build of the complete game, including all released expansions in a single self-contained package. The build requires no storefront and no additional software, and is ready to play immediately after installation.

Players who want a complete, self-contained offline edition of Cloudscrapers for Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3562200/ba361fbcde5d1f52ddb34313987e87c74914edc5/ss_ba361fbcde5d1f52ddb34313987e87c74914edc5.1920x1080.jpg?t=1789563887" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3562200/434d41236eff99d2b33fbb501e1077cdc587dd78/ss_434d41236eff99d2b33fbb501e1077cdc587dd78.1920x1080.jpg?t=1789563887" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3562200/114089b75c37636bde163c5b363312d717b3fc57/ss_114089b75c37636bde163c5b363312d717b3fc57.1920x1080.jpg?t=1789563887" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏙️ **Vertical City Building** — Construct layered megastructures with modular districts, transit, and utilities.
- 🌦️ **Dynamic Weather Systems** — Living cloud layers affect power output, transit routes, and citizen mood.
- 🛠️ **Mod Support** — Load community-made mods directly from a local folder.
- 🎮 **Sandbox Mode** — Unlimited resources and free-form construction for creative players.
- 🌐 **LAN Multiplayer** — Cooperative city planning via LAN or direct connection supported.
- 💾 **Offline Play** — Fully playable without an internet connection after installation.
- 📦 **All Content Included** — Base game plus every expansion bundled in one package.
- ⚙️ **Self-Contained Package** — No additional software required; ready to play immediately.

- **Compression:** Lossless
- **Install Time:** ~10 minutes on SSD, ~25 minutes on HDD
- **Recoding:** none
- **Selective Download:** Optional high-resolution texture pack and bonus soundtrack can be skipped during installation.
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 960 4 GB or AMD Radeon R9 380 | NVIDIA GeForce RTX 2060 or AMD Radeon RX 5700 |
| **Storage** | 12 GB available space | 12 GB on an SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12, broadband connection for community mod downloads |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Cloudscrapers\Saved`
